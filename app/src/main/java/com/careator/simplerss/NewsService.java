...
public class NewsService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ApplicationClass.connectionAvailable(getApplicationContext())) {
            RemoteViews views = new RemoteViews("com.careator.simplerss", R.layout.new_app_widget);
            views.setTextViewText(R.id.title, "Busy Retrieving Data... ");
            views.setTextViewText(R.id.description, "Busy Retrieving Data... ");
    ...
    public class GetStoriesInBackground extends AsyncTask<Integer, Integer, String> {
        ...
        protected String doInBackground(Integer... params) {
            ...
            try {
                //TODO Make a connection to RSS feed
        ...
        protected void onPostExecute(String result) {
            ...
            RemoteViews views = new RemoteViews("com.careator.simplerss", R.layout.new_app_widget);
            views.setTextViewText(R.id.title, titles.get(randomValue));
            views.setTextViewText(R.id.description, descriptions.get(randomValue));
            ...
            views.setOnClickPendingIntent(R.id.sync, pendingIntentSync);
